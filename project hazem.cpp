...
void seartch_item()
{
	...
	cout<<"enter the product is name : "<<endl;
	  ...
	  {
	  	system("color 5");
	  	cout<<"error found in the file : "<<endl;	  	system("color 7");
	  	exit(1);
	        }
	  ...
	  for(int i=0;i<50;i++)
	  {
	  	...
	  	system("cls");system("color 4");  cout<<"this item wasn't fournd in the database :  "<<endl;
	     seartch_item.close();
...
not_found: char x='0';
	...
	edit.close();
	cout<<"enter the name that you want to write it in the file : "<<endl;
	cin>>name_edit;
